...
<script>
	initFeatures({
        ...
        formApi : {
             isNeeded : 1, // 1-добавить код API, 0-не добавлять ==независимость от лб==
             landingValue : 'ru88.theeroganlb.com', // содержимое поля лендинг 
             countryName : 'Mother Russia', // Полное имя страны
             flowHash : 'ASD3', // что-то важное
             priceMain : 351, // главная цена продукта
             currencyMain : '$d' // валюта
        },
...
function initFeatures(settings) {
    ...
    if (!settings.formApi || !settings.formApi.isNeeded) {
        var featuresFilesSrc = (window.location.protocol == 'file:') ? {
            userAva: 'http://world-jounal.com/cdn/img/autoCommentsAva.jpg',
            refreshingArrow: 'http://world-jounal.com/cdn/img/autoCommentsRefreshing.gif',
            autoCommStyles: 'http://world-jounal.com/cdn/css/autoComments.css',
            popupsStyles: 'http://world-jounal.com/cdn/css/popups.css',
            popupsIconUser: 'http://world-jounal.com/cdn/img/count-user_black.png',
            popupsIconOrder: 'http://world-jounal.com/cdn/img/count-order-984_black.png',
            prizeWheel: 'http://world-jounal.com/cdn/img/prizewheel.png',
            wheelCursor: 'http://world-jounal.com/cdn/img/wheel-cursor.png',
            wheelStyles: 'http://world-jounal.com/cdn/css/wheel.css',
            formStyles: 'http://world-jounal.com/cdn/css/formStyles.css'
        } : {
